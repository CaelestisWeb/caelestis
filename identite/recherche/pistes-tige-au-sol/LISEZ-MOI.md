...
```bash
node identite/recherche/pistes-tige-au-sol/build-pistes.mjs     # les 55 fichiers, puis le contrôle de cadrage
node identite/recherche/pistes-tige-au-sol/build-planche.mjs    # la planche de présentation
```
