...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/recherche/pistes-moniteur-plante/tige-sol/tuile-creme-sur-vert.svg', legende: 'La Tige au sol, ligne raccourcie à 80' },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/recherche/pistes-tige-au-sol/, onze par largeur. Fabrication : node identite/recherche/pistes-tige-au-sol/build-pistes.mjs. Cette planche : node identite/recherche/pistes-tige-au-sol/build-planche.mjs. Toutes les séries se regardent ensemble avec node identite/serveur.mjs.",
};
