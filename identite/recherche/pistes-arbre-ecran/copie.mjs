...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/recherche/pistes-pousse/arbre-ecran/tuile-creme-sur-vert.svg', legende: "L'Arbre-écran de la troisième série, sans racines" },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/recherche/pistes-arbre-ecran/, onze par piste. Fabrication : node identite/recherche/pistes-arbre-ecran/build-pistes.mjs. Cette planche : node identite/recherche/pistes-arbre-ecran/build-planche.mjs. Toutes les séries se regardent ensemble avec node identite/serveur.mjs.",
};
