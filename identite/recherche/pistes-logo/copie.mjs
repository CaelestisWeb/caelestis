...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/recherche/pistes-logo/, onze par piste. Fabrication : node identite/recherche/pistes-logo/build-pistes.mjs, qui écrit les fichiers puis mesure leur cadrage au pixel. Cette planche : node identite/recherche/pistes-logo/build-planche.mjs.",
