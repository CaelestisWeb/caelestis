...
Une seconde série existe dans `identite/recherche/pistes-nature/` : la nature et le web dans la même forme. Celle-ci cherche un signe de marque, l'autre cherche un signe de métier.
...
```bash
node identite/recherche/pistes-logo/build-pistes.mjs     # les 56 fichiers, puis le contrôle de cadrage
node identite/recherche/pistes-logo/build-planche.mjs    # la planche de présentation
```
