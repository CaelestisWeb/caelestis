...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/recherche/pistes-arbre-ecran/enracine/tuile-creme-sur-vert.svg', legende: "L'Enraciné de la sixième série, écarté" },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/recherche/pistes-moniteur/, onze par piste. Fabrication : node identite/recherche/pistes-moniteur/build-pistes.mjs. Cette planche : node identite/recherche/pistes-moniteur/build-planche.mjs. Toutes les séries se regardent ensemble avec node identite/serveur.mjs.",
};
