...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/recherche/pistes-moniteur/plante/tuile-creme-sur-vert.svg', legende: 'Le Moniteur planté retenu, avec ses racines' },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/recherche/pistes-moniteur-plante/, onze par piste. Fabrication : node identite/recherche/pistes-moniteur-plante/build-pistes.mjs. Cette planche : node identite/recherche/pistes-moniteur-plante/build-planche.mjs. Toutes les séries se regardent ensemble avec node identite/serveur.mjs.",
};
