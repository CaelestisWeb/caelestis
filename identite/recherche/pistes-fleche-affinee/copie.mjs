...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/recherche/pistes-fleche/fleche-feuillue/tuile-creme-sur-vert.svg', legende: 'La Flèche feuillue, retenue le 7 septembre' },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/recherche/pistes-fleche-affinee/, onze par piste. Fabrication : node identite/recherche/pistes-fleche-affinee/build-pistes.mjs. Cette planche : node identite/recherche/pistes-fleche-affinee/build-planche.mjs. Toutes les séries se regardent ensemble avec node identite/serveur.mjs.",
};
