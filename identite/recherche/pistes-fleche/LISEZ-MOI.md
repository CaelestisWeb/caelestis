...
```bash
node identite/recherche/pistes-fleche/build-pistes.mjs     # les 55 fichiers, puis le contrôle de cadrage
node identite/recherche/pistes-fleche/build-planche.mjs    # la planche de présentation
```
