...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/pistes-nature/pousse/tuile-creme-sur-vert.svg', legende: 'La Pousse de la série précédente' },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/pistes-pousse/, onze par piste. Fabrication : node identite/pistes-pousse/build-pistes.mjs, qui écrit les fichiers puis mesure leur cadrage au pixel. Cette planche : node identite/pistes-pousse/build-planche.mjs. Les deux séries précédentes vivent dans identite/pistes-logo/ et identite/pistes-nature/, chacune avec sa planche.",
};
