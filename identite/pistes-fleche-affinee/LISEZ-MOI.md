...
```bash
node identite/pistes-fleche-affinee/build-pistes.mjs     # les 66 fichiers, puis le contrôle de cadrage
node identite/pistes-fleche-affinee/build-planche.mjs    # la planche de présentation
```
