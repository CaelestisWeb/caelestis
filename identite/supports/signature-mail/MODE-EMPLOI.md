...
Ce qui porte l'identité dans ce contexte : le vert forêt `#255C41`, la mousse foncée `#2E7452` sur la ligne de fonction, le filet mousse `#B8C4BB` de 34 pixels, et le signe.
