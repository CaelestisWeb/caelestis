...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/pistes-pousse/pousse/tuile-creme-sur-vert.svg', legende: 'La Pousse, votre préférée' },
  texte: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/pistes-fleche/, onze par piste. Fabrication : node identite/pistes-fleche/build-pistes.mjs. Cette planche : node identite/pistes-fleche/build-planche.mjs. Les quatre séries se regardent ensemble avec node identite/serveur.mjs.",
};
