...
export const DEPART = {
  ...
  texte: [
    ...
    "La première série reste disponible dans identite/pistes-logo/ : elle cherchait un signe de marque, celle-ci cherche un signe de métier. Les deux se lisent ensemble.",
  ],
  garde: [
...
export const BILAN = {
  ...
  pied: "Fichiers vectoriels dans identite/pistes-nature/, onze par piste. Fabrication : node identite/pistes-nature/build-pistes.mjs, qui écrit les fichiers puis mesure leur cadrage au pixel. Cette planche : node identite/pistes-nature/build-planche.mjs. La première série vit dans identite/pistes-logo/, avec sa propre planche.",
};
