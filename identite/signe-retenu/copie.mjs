...
export const DEPART = {
  ...
  specimen: { chemin: 'identite/signe-retenu/signe/favicon.svg', legende: 'Le favicon, contour ramené de 9,5 à 8' },
  texte: [
...
export const BILAN = {
  ...
  recommandation: {
    ...
    texte: [
      ...
      "Les quatre valeurs se règlent dans identite/signe-retenu/signes.mjs, dans la constante PETIT. Une seule ligne à changer si le contour doit encore maigrir.",
    ],
  },
  suite: {
    titre: 'La suite',
  ...
  pied: "Fichiers vectoriels dans identite/signe-retenu/signe/, onze au total. Fabrication : node identite/signe-retenu/build-pistes.mjs. Cette planche : node identite/signe-retenu/build-planche.mjs.",
};
