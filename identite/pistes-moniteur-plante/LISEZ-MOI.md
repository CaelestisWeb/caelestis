...
```bash
node identite/pistes-moniteur-plante/build-pistes.mjs     # les 55 fichiers, puis le contrôle de cadrage
node identite/pistes-moniteur-plante/build-planche.mjs    # la planche de présentation
```
